# Fashion Classification API Documentation
...
**cURL Example:**
```bash
curl -X GET https://fashion-classifier-api-728466800559.europe-west1.run.app/
```
...
**cURL Example:**
```bash
curl -X GET https://fashion-classifier-api-728466800559.europe-west1.run.app/health
```
...
**cURL Example:**
```bash
curl -X GET https://fashion-classifier-api-728466800559.europe-west1.run.app/classes
```
...
**cURL Example:**
```bash
curl -X GET https://fashion-classifier-api-728466800559.europe-west1.run.app/stats
```
...
**Cloud API (Google Cloud Run) Current Limits:**
